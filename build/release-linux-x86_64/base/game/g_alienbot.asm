...
import getEntityTeam
import requestNewGoal
import goalIsDamagedBuildingOnTeam
import goalIsArmoury
import goalIsMedistat
import goalIsEnemy
import botNeedsToHeal
import botOnLadder
import calcBarbAimDelta
import calcPounceAimDelta
